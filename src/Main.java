           ...
           while (account != null) {
               ...
               switch (choice) {
                   ...
                   case 3:
                       ...
                       break;
                   case 4:
                       String transfer_message = "Transfer failed";
                       System.out.print("Enter account ID of account to debit account : ");
                       String transferto_id  = input.next();

                       for (Account a : accounts) {
                           if (a.getId().equals(transferto_id) && !account.getId().equals(transferto_id)) {
                               System.out.print("Please enter amount : ");
                               amount = input.nextInt();

                               System.out.println("\ntransfer "+amount+" to "+a.getName());
...
//        System.out.println("\nYour id is : "+salem.getId());
//        System.out.println("Your salary is : "+ salem.getSalary());
//        int percent = 30;
//        System.out.println("raised percentage is : "+percent);
//        salem.raisedSalary(percent);
//        salem.print();
//
//
//        khaled.print();
